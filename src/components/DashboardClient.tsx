  ...
  return (
    <div className="flex flex-col gap-4">
      {urls.map((url) => (
        <div
          key={url.id}
          className="glass flex flex-col items-start justify-between p-5 transition-all hover:-translate-y-1 hover:border-cyan-500/30 md:flex-row md:items-center md:p-6"
        >
          <div className="flex flex-col gap-2 overflow-hidden w-full md:w-auto mb-4 md:mb-0">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="max-w-[280px] truncate text-sm text-zinc-500 transition-colors hover:text-zinc-700 sm:max-w-md dark:hover:text-zinc-400"
            >
              {url.original}
            </a>
          </div>
          ...
          <div className="flex items-center justify-between w-full md:w-auto gap-8">
            <div className="flex flex-col items-end">
              <span className="text-2xl font-bold leading-none text-zinc-900 dark:text-white">
                {url.clicks}
              </span>
